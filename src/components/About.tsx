            ...
            <div className="lg:w-2/3">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                  Student and passionate developer on a journey through clean,
                  responsive, user-focused web experiences. I'm always learning
                  and excited by modern technologies.
                </p>

                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                  My passion lies in creating beautiful, functional web
                  applications that solve real-world problems. I believe in the
