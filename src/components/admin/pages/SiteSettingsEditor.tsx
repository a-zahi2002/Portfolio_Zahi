  ...
  return (
    <div>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        {/* SEO */}
        <div className="p-5 bg-charcoal-800/40 border border-white/5 rounded-2xl space-y-4">
          <h3 className="text-sm font-semibold text-white">Default SEO</h3>
        ...
        <div className="p-5 bg-charcoal-800/40 border border-white/5 rounded-2xl space-y-4">
          ...
          <FormField label="Resume URL" htmlFor="set-resume">
            <Input id="set-resume" type="url" value={form.resume_url} onChange={e => update('resume_url', e.target.value)} placeholder="https://..." />
          </FormField>
