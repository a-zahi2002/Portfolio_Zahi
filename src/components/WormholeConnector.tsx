...
const WormholeConnector: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Continuous slow self-rotation of the galaxy arms
      gsap.to(galaxyArmsRef.current, {
        rotation: 360,
        duration: 35,
        repeat: -1,
        ease: "none",
      ...
      // Ambient local glows cross-fade
